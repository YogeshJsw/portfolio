...
export const Hero = () => {
  ...
  <div className={styles.content}>
    <h1 className={`${styles.title} ${styles.animatedTitle}`}>
      Hi, I'm <span>Y</span><span>o</span><span>g</span><span>e</span><span>s</span><span>h</span><span>&nbsp;</span>
    ...
    <a href="mailto:yogeshjaiswal.0811@gmail.com" className={styles.contactBtn}>Contact Me</a>
  </div>
